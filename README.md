...
- [React + Umi 项目](#react-umi-项目)
	...
	- [开始开发](#开始开发)
		...
		- [页面代码结构](#页面代码结构)
			- [`index.js`](#indexjs)
			- [`index.css`](#indexcss)
			- [`model.js` or `models/xxx.js`](#modeljs-or-modelsxxxjs)
...
1. 复制 `pages/martin` 目录到你想要的目录下，目录与 url 相对应（参见[路由介绍](#路由介绍)）。
2. 删除/注释掉你不需要的文件/代码，如 css/effects。
...
你可以用任意方式引入 css 文件。通常情况下，建议参照 `martin/index.js` 的例子，使用 [css modules](https://segmentfault.com/a/1190000010301977) 引入 `martin/index.css`。
